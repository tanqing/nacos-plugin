...
public class BaseHistoryConfigInfoMapper extends HistoryConfigInfoMapperByMySql {
    ...
    public MapperResult pageFindConfigHistoryFetchRows(MapperContext context) {
        String sql = databaseDialect.getLimitTopSqlWithMark("SELECT nid,data_id,group_id,tenant_id,app_name,src_ip,src_user,op_type,ext_info,publish_type,gray_name,gmt_create,gmt_modified FROM his_config_info WHERE data_id = ? AND group_id = ? AND tenant_id = ? ORDER BY nid DESC ");
